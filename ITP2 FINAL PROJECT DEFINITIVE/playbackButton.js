...
function PlaybackButton(){
    ...
    this.buttonAnimation = function(){
        ...
        //draw play button using uiStep to animate it
        fill(255,255,255,map(uiStep, 0, uiStepMax, 140, 255));
        triangle(x1, y1, x2, y2, x3, y3);
        
        //change cursor to pointer if it is within the play button 
        //- based on video “Check whether a given point lies 
        //inside a triangle or not | GeeksforGeeks” by 
        //GeeksforGeeks, found at: https://youtu.be/H9qu9Xptf-w
        aT = this.areaOfTriangle(x1, y1, x2, y2, x3, y3);
        a1 = this.areaOfTriangle(mx, my, x2, y2, x3, y3);
        a2 = this.areaOfTriangle(x1, y1, mx, my, x3, y3);
        a3 = this.areaOfTriangle(x1, y1, x2, y2, mx, my);
