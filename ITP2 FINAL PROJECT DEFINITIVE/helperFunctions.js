...
function userInstructions(){
    ...
    text(
        "Choose your visualization with the number keys:\n"+list, 
        0, topMargin
    );
    textSize(20);
    text("Click anywhere to pause", 0, topMargin + 160);
    text("Move your cursor when you are playing the song", 0, topMargin + 190);
